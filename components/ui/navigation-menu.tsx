   ...
   disabled:opacity-50 data-[active]:bg-accent/50 data-[state=open]:bg-accent/50`,
  {
    variants: {
      variant: {
        ...
        primary: `bg-gradient-to-r from-${brandConfig.colors.primary[500]} to-${brandConfig.colors.primary[600]} 
                 text-white hover:from-${brandConfig.colors.primary[600]} hover:to-${brandConfig.colors.primary[700]}`,
